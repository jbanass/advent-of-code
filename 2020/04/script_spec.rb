...
describe DayFour do
  let(:input) {
    [
      ...
      %w(pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
      hcl:#623a2f),

      %w(eyr:2029 ecl:blu cid:129 byr:1989
      ...
      %w(iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719)
    ]
  }
  ...
  describe "#calculate" do
    ...
    it "calculates correctly" do
      allow(Parser).to receive(:split_on_consecutive_newlines).and_return(input)
      expect(described_class.calculate).to eq(expected_result)
    end
  end
